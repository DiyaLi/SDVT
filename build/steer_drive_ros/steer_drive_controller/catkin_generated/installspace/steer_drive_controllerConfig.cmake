...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'steer_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/diya/sdvt2017/install/${idir}'.  Ask the maintainer 'Masaru Morita <p595201m@mail.kyutech.jp>' to fix it.")
    endif()

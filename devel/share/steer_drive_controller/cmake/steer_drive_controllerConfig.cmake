...
if("TRUE" STREQUAL "TRUE")
  set(steer_drive_controller_SOURCE_PREFIX /home/diya/sdvt2017/src/steer_drive_ros/steer_drive_controller)
  set(steer_drive_controller_DEVEL_PREFIX /home/diya/sdvt2017/devel)
  ...
  set(steer_drive_controller_INSTALL_PREFIX /home/diya/sdvt2017/install)
...
if(NOT "/home/diya/sdvt2017/src/steer_drive_ros/steer_drive_controller/include " STREQUAL " ")
  set(steer_drive_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/diya/sdvt2017/src/steer_drive_ros/steer_drive_controller/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'steer_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Masaru Morita <p595201m@mail.kyutech.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'steer_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/diya/sdvt2017/src/steer_drive_ros/steer_drive_controller/${idir}'.  Ask the maintainer 'Masaru Morita <p595201m@mail.kyutech.jp>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${steer_drive_controller_dep}_FOUND)
      find_package(${steer_drive_controller_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${steer_drive_controller_dep} REQUIRED ${depend_list})
  endif()
